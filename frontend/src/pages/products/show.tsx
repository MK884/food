    ...
    <Show isLoading={isLoading}>
      ...
      >
        ...
        >
          ...
          {(
            currentUser ? (<Stack display="flex" justifyContent="center" flexDirection="row" gap={4}><EditButton resource="Products" variant="contained" fullWidth /><DeleteButton fullWidth variant="contained" resource="Products"/></Stack>) :(<CustomButton
              title="Add to Cart"
        ...
        >
          ...
          <Stack gap={2} borderBottom="1px solid #e0e0e0" paddingBottom={4}>
            ...
            <Stack flexDirection="row" gap={1}>
              ...
              <Typography variant="caption">Sold By Reliance Retail</Typography>
            </Stack>
          </Stack>
          <hr />
          <Stack gap={2} borderBottom="1px solid #e0e0e0" paddingBottom={4}>
          ...
          <Stack gap={2} borderBottom="1px solid #e0e0e0" paddingBottom={4}>
            ...
            <Typography>
              ...
              milk without any complaints. It endures all the proteins from milk
              along with giving an added flavour for tasty consumption.
              Moreover, its packaging makes it easier to stock up or carry while
              travelling. A yummy treat for both adults and children, buy Amul
              Kool Rose Flavoured Milk online today!
            </Typography>
          </Stack>
          <Stack gap={2} borderBottom="1px solid #e0e0e0" paddingBottom={4}>
            <Typography fontSize={25} fontWeight={700}>
            ...
            <table>
              ...
              <tr>
                ...
                <td width="70%">
                  ...
                  Dairy Road, Anand 388 001, Gujarat, India.
                </td>
              </tr>
            </table>
          </Stack>
